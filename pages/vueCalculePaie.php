...
<html>
	<head>
		<meta charset="utf-8" />
		<title>Calcule des présalaires</title>
			...
			<div class="container">
				...
				<div class="panel panel-default espace80">
					...
					<div class="panel-body">
						<form method="get" action="vueSaisirPointage.php" class="form-inline">
						...
						<table class="table table-striped">
							...
							<tbody>
									...
									<tr>
										...
										<td>
                                             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <a class="btn btn-blue btn-sm"  style="margin-top:-5px; margin-bottom:-5px;"
                                               href="vueCalculerPaie.php?matricule=<?php echo $apprenti['MATRICULE'] ?>">
                                                  <span class="fas fa-cash-register"
								...
								<ul class="nav nav-pills nav-right">
									...
									<?php for($i=1;$i<=$nbrPages;$i++){ ?>
										<li class="<?php if($i==$page) echo 'active' ?>">
											<a href="vueSaisirPointage.php?page=<?php echo $i ?>
											&motCle=<?php echo $mc ?>
											&size=<?php echo $size ?>">
												Page <?php echo $i ?>
											</a>
