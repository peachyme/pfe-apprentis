...
include '../fonctions/fonctions.php'; 
   ...
   if ($_SERVER['REQUEST_METHOD'] == 'POST') 
   {
       ...
       header("location:vueModifierPaieParApp.php?matricule=$mat&nba=$NBA&date=$date&paie=$paie&id=$id");
			...
			<div class="panel panel-info" >
				...
				<div class="panel-body">
					<form method="post" action="<?php echo $_SERVER['PHP_SELF'] ?>" class="form">
                        ...
                        <a href="updatePaieParApp.php?matricule=<?php echo $mat ?>&id=<?php echo $id ?>
                                 &nba=<?php echo $NBA ?>&paie=<?php echo $paie ?>"
