                        ...
                        <div class="form-group">
                            ...
                            <select name="role" id="role" class="form-control">
                                <option value="Chef de service" 
                                        <?php if($role=="Chef de service") echo "selected" ?>>Chef de service</option>	
                                
                                <option value="Gestionnaire" 
                                        <?php if($role=="Gestionnaire") echo "selected" ?>>Gestionnaire</option>
                                
                                <option value="Secrétaire" 
                                        <?php if($role=="Secrétaire") echo "selected" ?>>Secrétaire</option>
                                
                                <option value="Visiteur" 
                                        <?php if($role=="Visiteur") echo "selected" ?>>Visiteur</option>	
                            </select>
                        </div>
