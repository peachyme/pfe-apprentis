...
$resultatListPaie = $connexion->query( "SELECT  PAIE.MATRICULE, NOM, PRENOM, PAIE_P, NB_ABS, CCP
                                        FROM PAIE, APPRENTI
...
$pdf->Cell(60, 10, "   Apprenti", 'LB', 0, 'L');
$pdf->Cell(50, 10, "   Nombre d'absence", 'B', 0, 'L');
$pdf->Cell(40, 10, "   Paie", 'B', 0, 'L');
$pdf->Cell(40, 10, "   Compte CCP", 'RB', 1, 'L');
$pdf->SetFont('Arial', '', 10);
 ...
 while($paie = $resultatListPaie->fetch()){
     ...
     $paiee = $paie['PAIE_P'];
     $ccp = $paie['CCP'];
    $pdf->Cell(60, 10,  "   ".$nom." ". $prenom, 'L', 0, 'L');
    $pdf->Cell(50, 10, "                ".$nb, '', 0, 'L');
    $pdf->Cell(40, 10, "   ".$paiee."  DA", '', 0, 'L');
    $pdf->Cell(40, 10, "   ".$ccp, 'R', 1, 'L');
}
